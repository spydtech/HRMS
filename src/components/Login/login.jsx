...
function Login() {
  ...
  return (
    <div className="bg-[#0098F1] w-screen h-screen flex items-center justify-center px-4 md:px-8 lg:px-12">
      <div
        className="relative w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl h-auto md:h-[350px] rounded-[30px] flex flex-col items-center justify-center shadow-xl p-8"
        style={{
          background:
        ...
        >
          ...
          <div className="relative">
            <div className="absolute left-3 top-1/2 transform -translate-y-1/2">
              {showPassword ? (
                <IoMdEyeOff
                  className="w-6 h-6  text-[#00588B] cursor-pointer"
            ...
            />
            <div className="text-sm text-white mt-2 sm:absolute sm:right-3 sm:top-1/2 sm:transform sm:-translate-y-1/2">
