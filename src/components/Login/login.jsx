...
// import { IoMdContact, IoMdEye, IoMdEyeOff } from "react-icons/io"; // Import correct icons from react-icons
...
//   return (
//     <div className="bg-[#0098F1] w-screen h-screen flex items-center justify-center">
//       <div
//         className="relative w-[600px] max-w-[100%] h-[350px] rounded-[55px] flex flex-col items-center justify-center shadow-xl p-8"
//         style={{
//           background:
...
//             />
//             <div>
//               <Link className="text-sm text-white ml-80 hover:underline cursor-pointer">
//                 Forgot Password?
//               </Link>
//             </div>
//           </div>
