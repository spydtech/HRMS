...
<SideBar />
        ...
        <div className="max-w-full px-14 py-11 rounded-lg bg-white ">
            <h2 className="text-2xl font-semibold mb-10 mt-4 text-center text-orange-400">Add Department List</h2>
            <form onSubmit={handleSubmit} className='flex flex-col md:mx-[240px] mx-[0px]'>
            <div className="mmd:b-6"> 
                    ...
                    <div className="bg-[#2a97db] z-50 p-8 rounded-lg shadow-lg" onClick={(e) => e.stopPropagation()}>
                        ...
                        <BsCheck2Circle  className='text-white text-[40px]'/>
                            ...
                            <span className='text-white'>
                                New Department Added <br/>Successfully
                            </span>
                        </div>
                    </div>
                </div>
